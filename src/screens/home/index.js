...
import TransacionListView from '../transactions/transaction-list-view';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bodyContainer}>
        <TransacionListView data={transactions.slice(0, 5)} ListHeaderComponent={ListHeaderComponent} ListFooterComponent={ListFooterComponent}/>
        {/* <SwipeableFlatList
